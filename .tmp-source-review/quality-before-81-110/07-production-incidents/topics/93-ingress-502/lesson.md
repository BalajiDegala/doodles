# 93. Ingress returns 502 after deployment

## Concise technical summary

1. Readiness, Service targetPort, endpoints, and controller logs.
...
Further reading: [Ingress returns 502 after deployment](https://kubernetes.io/docs/concepts/services-networking/ingress/).
