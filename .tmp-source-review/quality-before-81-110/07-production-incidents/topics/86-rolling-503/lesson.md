# 86. Rolling update returns 503: make shutdown and readiness cooperate

## Concise technical summary

1. PreStop, termination grace, readiness transition, and endpoint removal.
...
Further reading: [Rolling update returns 503: make shutdown and readiness cooperate](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/).
