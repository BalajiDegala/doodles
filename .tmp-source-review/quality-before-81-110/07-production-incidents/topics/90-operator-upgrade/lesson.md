# 90. Cluster upgrade breaks CRDs or operators

## Concise technical summary

1. Compatibility order: APIs, CRDs, operators, then workloads.
...
Further reading: [Cluster upgrade breaks CRDs or operators](https://kubernetes.io/docs/tasks/administer-cluster/cluster-upgrade/).
