# 92. Pod evicted for disk pressure: reclaim space without data loss

## Concise technical summary

1. Ephemeral storage accounting, image garbage collection, and durable volumes.
...
Further reading: [Pod evicted for disk pressure: reclaim space without data loss](https://kubernetes.io/docs/concepts/scheduling-eviction/node-pressure-eviction/).
