# 85. OOMKilled: account for the whole container memory footprint

## Concise technical summary

1. Why heap-only reasoning misses native memory, page cache, and process trees.
...
Further reading: [OOMKilled: account for the whole container memory footprint](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/).
