# 91. HPA flapping: stabilize scale-up and scale-down

## Concise technical summary

1. HPA behavior policies, stabilization windows, and good metrics.
...
Further reading: [HPA flapping: stabilize scale-up and scale-down](https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/).
