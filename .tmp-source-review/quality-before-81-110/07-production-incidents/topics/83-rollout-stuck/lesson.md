# 83. Deployment rollout stuck: distinguish readiness, capacity, and disruption blockers

## Concise technical summary

1. How to read rollout status, ReplicaSets, PDBs, and scheduler events before changing replicas.
...
Further reading: [Deployment rollout stuck: distinguish readiness, capacity, and disruption blockers](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/).
