# 95. StatefulSet Pod stuck terminating

## Concise technical summary

1. Finalizers, volume detach, grace periods, and force-delete risks.
...
Further reading: [StatefulSet Pod stuck terminating](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/).
