# 84. PVC pending: classify storage class, binding mode, and provisioning failures

## Concise technical summary

1. StorageClass, CSI, topology, and WaitForFirstConsumer diagnostics.
...
Further reading: [PVC pending: classify storage class, binding mode, and provisioning failures](https://kubernetes.io/docs/concepts/storage/persistent-volumes/).
