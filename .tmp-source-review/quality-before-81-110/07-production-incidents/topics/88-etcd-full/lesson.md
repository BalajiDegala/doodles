# 88. etcd database full: recover safely before writes stop

## Concise technical summary

1. Quota alarms, compaction, defragmentation, and key-size hygiene.
...
Further reading: [etcd database full: recover safely before writes stop](https://etcd.io/docs/v3.5/op-guide/maintenance/).
