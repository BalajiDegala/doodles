# 94. Cross-namespace traffic blocked after NetworkPolicy

## Concise technical summary

1. Namespace selectors and additive ingress rules.
...
Further reading: [Cross-namespace traffic blocked after NetworkPolicy](https://kubernetes.io/docs/concepts/services-networking/network-policies/).
