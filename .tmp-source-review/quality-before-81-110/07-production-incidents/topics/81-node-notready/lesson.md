# 81. Node NotReady: isolate the failure before evicting workloads

## Concise technical summary

1. Node health, kubelet heartbeats, pressure signals, and safe cordon/drain decisions.
...
Further reading: [Node NotReady: isolate the failure before evicting workloads](https://kubernetes.io/docs/concepts/architecture/nodes/).
