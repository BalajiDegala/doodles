# 87. DNS race or intermittent lookup failures inside Pods

## Concise technical summary

1. Search paths, CoreDNS capacity, conntrack, and node-local caching.
...
Further reading: [DNS race or intermittent lookup failures inside Pods](https://kubernetes.io/docs/tasks/administer-cluster/dns-debugging-resolution/).
