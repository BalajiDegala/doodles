# 89. Secret accidentally exposed in logs: contain, rotate, and scrub

## Concise technical summary

1. Immediate credential rotation plus log retention and audit review.
...
Further reading: [Secret accidentally exposed in logs: contain, rotate, and scrub](https://kubernetes.io/docs/concepts/configuration/secret/).
