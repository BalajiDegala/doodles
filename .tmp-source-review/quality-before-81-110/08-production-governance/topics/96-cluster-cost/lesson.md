# 96. Cluster costs spike unexpectedly

## Concise technical summary

1. Right-sizing, idle resource detection, and ownership attribution.
...
Further reading: [Cluster costs spike unexpectedly](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/).
