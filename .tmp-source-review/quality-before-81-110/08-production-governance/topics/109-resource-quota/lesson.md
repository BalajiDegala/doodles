# 109. Namespace quota blocks a new workload

## Concise technical summary

1. Quota usage, requests versus limits, and accurate workload accounting.
...
Further reading: [Namespace quota blocks a new workload](https://kubernetes.io/docs/concepts/policy/resource-quotas/).
