# 97. Namespace deletion stuck on finalizers

## Concise technical summary

1. Find remaining objects, repair controller-owned finalizers, and verify cleanup.
...
Further reading: [Namespace deletion stuck on finalizers](https://kubernetes.io/docs/concepts/overview/working-with-objects/finalizers/).
