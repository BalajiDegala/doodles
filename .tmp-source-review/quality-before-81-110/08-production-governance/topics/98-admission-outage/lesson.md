# 98. Admission webhook outage blocks every deployment

## Concise technical summary

1. Scope, timeout, failurePolicy, and emergency recovery for webhooks.
...
Further reading: [Admission webhook outage blocks every deployment](https://kubernetes.io/docs/reference/access-authn-authz/extensible-admission-controllers/).
