# 102. Pod resolves cluster DNS but not external DNS

## Concise technical summary

1. CoreDNS forwarding, egress policy, node resolver, and firewall checks.
...
Further reading: [Pod resolves cluster DNS but not external DNS](https://kubernetes.io/docs/tasks/administer-cluster/dns-debugging-resolution/).
