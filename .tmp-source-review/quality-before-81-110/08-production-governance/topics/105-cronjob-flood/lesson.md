# 105. CronJob creates thousands of completed Pods

## Concise technical summary

1. History limits, TTL-after-finished, concurrency policy, and cleanup.
...
Further reading: [CronJob creates thousands of completed Pods](https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/).
