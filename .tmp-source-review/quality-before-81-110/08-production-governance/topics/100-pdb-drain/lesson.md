# 100. Node drain kills too many replicas despite a PDB

## Concise technical summary

1. Selector correctness, eviction API, anti-affinity, and unhealthy replicas.
...
Further reading: [Node drain kills too many replicas despite a PDB](https://kubernetes.io/docs/concepts/workloads/pods/disruptions/).
