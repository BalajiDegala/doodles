# 99. Certificate expired: kubelet cannot talk to the API server

## Concise technical summary

1. Detect, renew, approve, and replace affected node or control-plane certificates.
...
Further reading: [Certificate expired: kubelet cannot talk to the API server](https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-certs/).
