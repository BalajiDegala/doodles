# 107. Upgrade a cluster safely with a rollback plan

## Concise technical summary

1. Version skew, deprecated APIs, backups, staging, and controlled rollout.
...
Further reading: [Upgrade a cluster safely with a rollback plan](https://kubernetes.io/releases/version-skew-policy/).
