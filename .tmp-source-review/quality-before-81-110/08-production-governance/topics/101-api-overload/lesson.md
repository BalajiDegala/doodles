# 101. API server overloaded: slow kubectl and controller loops

## Concise technical summary

1. Request latency, noisy clients, APF, and etcd I/O.
...
Further reading: [API server overloaded: slow kubectl and controller loops](https://kubernetes.io/docs/concepts/cluster-administration/flow-control/).
