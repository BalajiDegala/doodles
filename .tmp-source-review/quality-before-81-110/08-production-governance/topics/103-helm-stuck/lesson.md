# 103. Helm release stuck in pending-upgrade

## Concise technical summary

1. Inspect release history, rollback, and recover orphaned release state.
...
Further reading: [Helm release stuck in pending-upgrade](https://helm.sh/docs/helm/helm_rollback/).
