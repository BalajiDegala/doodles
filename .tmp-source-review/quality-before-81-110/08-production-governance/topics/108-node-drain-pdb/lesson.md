# 108. Node drain cannot evict a Pod because of PDB

## Concise technical summary

1. Eviction status, replica placement, unhealthyPodEvictionPolicy, and recovery.
...
Further reading: [Node drain cannot evict a Pod because of PDB](https://kubernetes.io/docs/concepts/workloads/pods/disruptions/).
