...
~~~powershell
cd kubernetes-learning-lab/08-production-governance
$ctx = kubectl config current-context
$ns = 'k8s-learning-governance'
...
kubectl --context $ctx -n $ns rollout status deployment/governance-catalog --timeout=120s
kubectl --context $ctx -n $ns exec deployment/governance-catalog -- wget -T 3 -qO- http://governance-catalog
~~~
